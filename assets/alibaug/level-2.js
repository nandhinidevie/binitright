...
const images = [
    { src: "https://i.postimg.cc/26907rTF/broken-ceramic.png", correctBin: ["ww-grey"], name: { mr: "तुटलेली चिनीमातीची भांडी", en: "Broken Ceramic" } },
    { src: "https://i.postimg.cc/rsvg7jBD/broken-terracotta.png", correctBin: ["ww-grey"], name: { mr: "तुटलेली मातीची भांडी", en: "Broken Terracotta" } },
    ...
    { src: "https://i.postimg.cc/YCN8y1bS/coconut-shell.png", correctBin: ["ww-blue"], name: { mr: "नारळाचे कवच, करवंटी", en: "Coconut Shell" } },
    { src: "https://i.postimg.cc/fyghR5nP/Expired-meds.jpg", correctBin: ["ww-grey"], name: { mr: "रिकामी औषध पाकीट", en: "Empty Medicine" } },
    { src: "https://i.postimg.cc/bNVqStQs/fish-bone.png", correctBin: ["ww-green"], name: { mr: "माशाचे हाड", en: "Fish Bone" } },
    { src: "https://i.postimg.cc/NjWYpvCt/food-waste-1.png", correctBin: ["ww-green"], name: { mr: "अन्न", en: "Food Waste" } },
    { src: "https://i.postimg.cc/Mpcq7pDt/garland.png", correctBin: ["ww-green"], name: { mr: "फुलांचा हार", en: "Garland" } },
    ...
    { src: "https://i.postimg.cc/6pZF62zs/rusted-nuts.png", correctBin: ["ww-blue"], name: { mr: "गंजलेले नट", en: "Rusted Nuts" } },
    { src: "https://i.postimg.cc/PqzcZgB2/stale-bread.png", correctBin: ["ww-green"], name: { mr: "शिळे ब्रेड", en: "Stale Bread" } },
    { src: "https://i.postimg.cc/9MmkBx2V/takeaway-styro.png", correctBin: ["ww-blue"], name: { mr: "पार्सल चे डब्बे", en: "Takeaway Styro" } },
    { src: "https://i.postimg.cc/ZRwMsrYN/tea-waste.png", correctBin: ["ww-green"], name: { mr: "उरलेली चहापावडर", en: "Tea Waste" } },
    { src: "https://i.postimg.cc/gj5BmmZk/tin.png", correctBin: ["ww-blue"], name: { mr: "पत्र्याचे डब्बे", en: "Tin" } },
