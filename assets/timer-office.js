        ...
        const images = [
            { src: "https://i.postimg.cc/3NbSfDt5/ww-tea.png", correctBin: "blue-bin" },
            { src: "https://i.postimg.cc/DypkRSSz/paperbag.png", correctBin: "blue-bin" },
            { src: "https://i.postimg.cc/C1s975yS/takeaway-plastic.png", correctBin: "red-bin" },
            { src: "https://i.postimg.cc/25cDgHCp/orange-1.png", correctBin: "green-bin" },
            { src: "https://i.postimg.cc/qBCTZXYY/can-1.png", correctBin: "red-bin" },
            { src: "https://i.postimg.cc/wxFSs1ck/apple.png", correctBin: "green-bin" },
            { src: "https://i.postimg.cc/jdHrRqR4/paper-1.png", correctBin: "blue-bin" },
            { src: "https://i.postimg.cc/Fs54tkXK/cover-1.png", correctBin: "red-bin" },
            { src: "https://i.postimg.cc/XJbT9Fzs/snack-cover.png", correctBin: "red-bin" },
            { src: "https://i.postimg.cc/nzNthCs0/pizza-box-1.png", correctBin: "blue-bin" },
            { src: "https://i.postimg.cc/j5tFDTD9/ww-paper-bag-2.png", correctBin: "blue-bin" },
            { src: "https://i.postimg.cc/vB4syWm4/banana-1.png", correctBin: "green-bin" },
            { src: "https://i.postimg.cc/RFdbfYf0/ww-plate.png", correctBin: "blue-bin" }
        ];
        ...
        function updateImage() {
            if (currentIndex < images.length) {
                ...
                let timeTaken = Math.floor((Date.now() - startTime) / 1000, 1);
                tickingAudio.pause(); // Stop ticking if the player finishes before time's up
                tickingAudio.currentTime = 0;
                celebrationAudio.play();
                startFireworks();
                showModal("🎉", `Well done! You sorted the waste in ${timeTaken} secs.`, `If ${timeTaken} seconds is all it takes, why not do it every day? If you don’t, your unsorted waste spends 500 years polluting our air, water, and land.`, false, true);
            }
        }
